...
config.General.requestName = 'ZprimeToA0hToA0chichihWWTollnunu_2HDM_MZp-600_MA0-300_Mchi1-1_ctau-1_13TeV-madgraph_AODSIM'
config.General.workArea = 'crab_projects'

config.JobType.pluginName = 'Analysis'
#config.JobType.generator = 'lhe'
config.JobType.psetName = 'EXO-RunIISummer16DR80Premix-01695_step2_cfg.py'
...
config.Data.userInputFiles = open('EXO-RunIISummer16DR80Premix-01695_step2_RAW.txt').readlines()
