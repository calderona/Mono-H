...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file:Zprime_A0h_A0chichi_MZp1000_MA0300.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/monoHiggs/pythia8_hadronizer_nomatching_HWWllnunu_cff.py nevts:10'),
